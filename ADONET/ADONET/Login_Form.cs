...
namespace ADONET
{
    public partial class Form5 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (rd.HasRows)
                button1.Enabled = true;//Enable the button if credentials are correct
            else
            {
                MessageBox.Show("Sorry , Wrong Credentials");// Disable the button if credentials are incorrect
