/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~    ADO.NET    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 * It is a module of .Net framework used to establish connection between application & data source
 * Data Source being SQL Server & XML.
 * ADO.NET consists of classes used to connect , retreive , insert and delete data.
 * ADO.NET classes are located in System.Data.dll & integrated with XML classes located in System.Xml.dll
 * DataSet=>Allows performing processing of data without an open connection. 
    i.e it can work while connection is disconnected.
 * DataReader=>Does not perform in disconnected mode.Requires DataReader object to be connected.
 * 
 */

 /*~~~~~~~~~~~~~~~~~~~~~~~~~~~   Data Provider   ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  
  * Used to connect to database, execute command and retrieve the record.
  * Lightweight Comp with better performance bcz it can directly access SQL server .
  * Core objects of Data Providers include:
    => Connection : Used to establish a connection to a specific data source.
    => Command    : Used to execute queries to perform database operations.
    => DataReader : Used to read the data from data source.
    => DataAdapter: Populate Data Set and resolve updates with data source.
    => Exception  : Used to throw SQL exceptions .Throws an exception when error is occured.
  */
    ...
    public partial class Form1 : Form
    {
       ...
       //INSERT
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            // command.Parameters.AddWithValue("@code", textBox1.Text); we can also directly use
